...
public class AnalisisDeDatosEstudiante {
...
private static Object consola;
    ...
    public static void IngresoDatos() throws IOException  { //MENU PRODUCTOS
           Scanner op = new Scanner(System.in);
           int opc = 0;
           int respuesta = 0;
           do{
    ...
    public static void AnalisisDatos() throws IOException  { 
           Scanner op = new Scanner(System.in);
           int opc ;
           int respuesta;
           do{
